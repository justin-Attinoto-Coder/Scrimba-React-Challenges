...
/* Challenge
    ...
    The variables below are currently hardcoded with data. Your task is to convert them to dynamically-generated values by doing the following: 
        ...
        4. The variables can be set up in a more efficient way than the one below. You may change 
           the way they're set up however you want, as long as the final results rendered onto the screen are the desired ones. Try to make your code as concise and DRY (Don't Repeat Yourself) as possible, while maintaining readability.
...
*/               
    ...
    const numericalChange = currentPrice - prevClosingPrice
        
    const rateChange = ((numericalChange / prevClosingPrice) * 100).toFixed(2)
    
    const numericalChangeStr = numericalChange.toFixed(2)
