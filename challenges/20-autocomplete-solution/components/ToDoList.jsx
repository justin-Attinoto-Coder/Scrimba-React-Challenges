...
/* Challenge
    ...
    comments. Aspects of this code are relevant to completing these tasks. However, you do not need to make any modifications to this code. You do not need to make any modifications to this code. You just need to understand it!  
*/
		...
		<div>
			<div className="to-do-list-container">
				...
				<label className="new-item-label">
					<img
						src="../images/active/add-item.svg"
